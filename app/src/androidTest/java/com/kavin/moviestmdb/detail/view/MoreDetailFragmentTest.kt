...
import com.kavin.moviestmdb.util.CustomMatcher
import com.kavin.moviestmdb.utils.di.DaggerTestAppComponent
...
class MoreDetailFragmentTest {
    ...
    private lateinit var app: MovieApp
    ...
    fun setup() {
        ...
        app = instrumentation.targetContext.applicationContext as MovieApp
